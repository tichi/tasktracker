...
{
    /**
     * \brief Authentication integration tests for FireFox 5.0.
     * \author Katharine Gillis
     * \date 2011-09-10
     * 
     * Runs the authentication integration tests on the FireFox 5.0 browser.
     */
    [TestFixture]
    [Category("FireFox")]
    class LogOnLogOutTests : TaskTrackerIntegrationTests.Base.LogOnLogOutTests
    {
         ...
         * 
         * This runs the valid log in and log out test on the FireFox 5.0 browser.
         */
        [Test]
         ...
         * 
         * This runs the invalid log in test on the FireFox 5.0 browser.
         */
        [Test]

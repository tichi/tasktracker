...
{
    /**
     * \brief Home page integration tests for FireFox 3.6.
     * \author Katharine Gillis
     * \date 2011-09-10
     * 
     * Runs the Home page integration tests on the FireFox 3.6 browser.
     */
    [TestFixture]
    [Category("Home")]
    class HomeTests : TaskTrackerIntegrationTests.Base.HomeTests
    {
         ...
         * 
         * This runs the default url test with the FireFox 3.6 browser.
         */
        [Test]
